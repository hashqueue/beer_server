...
module.exports = {
  ...
  systemName: 'Beer自动化测试平台', //系统名称
  copyright: '2021 anonymous', //copyright
  ...
  animate: {
    ...
    name: 'bounce', //动画效果，支持的动画效果可参考 ./animate.configs.js
    direction: 'left' //动画方向，切换页面时动画的方向，参考 ./animate.configs.js
  },
  footerLinks: [
