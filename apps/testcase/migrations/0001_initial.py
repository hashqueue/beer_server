    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase_desc', models.CharField(blank=True, help_text='测试用例描述', max_length=128, verbose_name='测试用例描述')),
        ...
        migrations.CreateModel(
            name='TestStepVariable',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unique_var_key', models.CharField(blank=True, help_text='变量的key', max_length=128, unique=True, verbose_name='变量的key')),
                ('var_value', models.TextField(blank=True, help_text='变量的value(jmespath表达式)', verbose_name='变量的value(jmespath表达式)')),
                ('var_key_type', models.CharField(blank=True, choices=[('export', '测试用例导出变量'), ('extract', '测试用例提取变量')], help_text='变量类型', max_length=25, verbose_name='变量类型')),
                ('desc', models.CharField(blank=True, help_text='变量描述', max_length=512, verbose_name='变量描述')),
                ('teststep', models.ForeignKey(help_text='所属测试步骤', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='step_variables', to='testcase.teststep', verbose_name='所属测试步骤')),
            ],
            options={
                'verbose_name': '测试步骤的变量(导出/提取变量)',
                'verbose_name_plural': '测试步骤的变量(导出/提取变量)',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('var_key', models.CharField(blank=True, help_text='请求参数的key', max_length=128, verbose_name='请求参数的key')),
                ('var_value', models.TextField(blank=True, help_text='请求参数的value(参数值/jmespath表达式)', verbose_name='请求参数的value(参数值/jmespath表达式)')),
                ('var_key_type', models.CharField(blank=True, choices=[('params', '查询字符串参数'), ('data', 'body中的form类型参数'), ('headers', '请求头参数'), ('cookies', 'cookie')], help_text='请求参数类型', max_length=25, verbose_name='请求参数类型')),
                ('desc', models.CharField(blank=True, help_text='请求参数描述', max_length=512, verbose_name='请求参数描述')),
