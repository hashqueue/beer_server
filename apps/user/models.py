...
class User(AbstractUser):
    ...
    department = models.CharField(max_length=128, blank=True, verbose_name='部门名称', help_text='部门名称')
    position = models.CharField(max_length=128, blank=True, verbose_name='职位名称', help_text='职位名称')
