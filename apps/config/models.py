...
class Config(BaseModel):
    ...
    global_variable = models.JSONField(null=True, blank=True, verbose_name='全局变量', help_text='全局变量')
    global_func = models.TextField(blank=True, default='', verbose_name='全局函数', help_text='全局函数')
